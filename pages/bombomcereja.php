...
<br>
            <h5>Bombom de Cereja</h5>
<br>
			<div class="center">
			<img src="../img/bombom/bombomcereja.jpg" width="350" height="350" alt="bolo 3 leites">
				<p>
				Doce de leite condensado recheado com Cereja e cobertura de chocolate preto enfeitado com Cereja
                Conservação: 10 a 12 Dias em temperatura ambiente, Aspectos Nutricionais: Este Doce Contém Glúten
                e Lactose em sua composição. O prazo de validade deste doce é considerado enquanto se mantiverem
                as características originais de sabor, apresentação, textura, cor e principalmente ausência de
                desenvolvimento de contaminação microbiológica. Proibições de alterações da receita: Não são
